...
public class LambdaStaticInstrumentation extends ClassStaticMethodsEnhancePluginDefine {
    private static final String LAMBDA_PREFIX = "lambda$";
    private static final String LAMBDA_METHOD_INTERCEPTOR = "org.apache.skywalking.apm.plugin.jdk.lambda.LambdaStaticMethodInterceptor";
